...
(
   ...
   evaluation_result    varchar(600) comment '评价结果',
   doc_mul              varchar(100) comment '附件集合',
   duty_person          varchar(20) comment '责任人',
...
(
   ...
   contacts_name   varchar(20) comment '联系人名称',
   contacts_phone   varchar(11) comment '联系方式',
   contacts_email   varchar(50) comment '邮件地址',
